...
class LightModel : public ExampleBase
{
...
public:
	...
	void renderLoop() {
		...
		glUniform1i(shader->getUniformId("specularMap"), 1);
	...
	void resetMatrix() {
		...
		glUniform3fv(shader->getUniformId("eyePos"), 1, &camera.Position[0]);
	}

	void initTextures() {
		glGenTextures(2, textures);

		char* pics[2] = { "images/container_diffuse.png", "images/container_specular.png" };
